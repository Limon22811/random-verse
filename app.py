...
while loop:
    ...
    print(f"""Chapter Name: {Fore.LIGHTGREEN_EX}{Style.BRIGHT}{chapters[chapter]}{Style.BRIGHT}{Fore.RESET}
    Chapter No. {Fore.LIGHTCYAN_EX}{Style.BRIGHT}{chapter}{Style.BRIGHT}{Fore.RESET}
